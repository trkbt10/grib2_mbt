...
| `-code_table_4.7` | [x] | [x] |
| `-code_table_4.8` | [x] | [x] |
| `-code_table_4.11s` | [x] | [x] |
| `-code_table_4.15` | [x] | [x] |
| `-code_table_4.16` | [x] | [x] |
| `-code_table_4.91` | [x] | [x] |
| `-code_table_4.91b` | [x] | [x] |
| `-code_table_4.230` | [x] | [x] |
| `-code_table_4.233` | [x] | [x] |
| `-code_table_4.235` | [x] | [x] |
| `-code_table_4.240` | [x] | [x] |
| `-code_table_4.241` | [x] | [x] |
| `-code_table_4.242` | [x] | [x] |
| `-code_table_5.4` | [x] | [x] |
| `-code_table_5.5` | [x] | [x] |
| `-code_table_5.6` | [x] | [x] |
| `-code_table_5.7` | [x] | [x] |
...
### 優先度 中 - code_table系 (全49個実装完了)

コードテーブル値の詳細表示。全49個実装済み。

| カテゴリ | 数 | 実装済み | 例 |
|----------|----|----|-------|
| Section 0 | 1 | 1 | `-code_table_0.0` ✓ |
| Section 1 | 7 | 7 | `-code_table_1.0~1.6` ✓ |
| Section 3 | 10 | 10 | `-code_table_3.0~3.21` ✓ |
| Section 4 | 25 | 25 | `-code_table_4.0~4.242` ✓ |
| Section 5 | 6 | 6 | `-code_table_5.0~5.7` ✓ |
