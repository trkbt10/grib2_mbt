...
TMP_MANIFEST="target/process_unmerge_fcst_cases.tsv"
SOURCE_MANIFEST="fixtures/wgrib2_snapshots/process/manifest_v2.tsv"
PATTERN='_unmerge_fcst_bin'
...
echo "[2/3] write unmerge_fcst subset manifest"
{
...
echo "[3/3] compare unmerge_fcst subset"
